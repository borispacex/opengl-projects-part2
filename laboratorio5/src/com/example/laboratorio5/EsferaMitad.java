...
public class EsferaMitad {
	...
	public EsferaMitad(float radio, int segmentosH, int segmentosV, int color1, int color2, int color3) {
		...
		// longitud
		for (float phi = 0; phi < 180; phi += inc_phi) {
	...
	public void dibuja(GL10 gl) {
		 ...
		 * normales e indices)
		 */
		// gl.glColor4f(maxColor1, maxColor2, maxColor3, 0);		// color
