	...
	public boolean onTouchEvent(MotionEvent e) {
		...
		if (e.getAction() == MotionEvent.ACTION_UP) {
			...
			if (fin == 0) {
				...
				if (verificaGana() == 1) {
					Toast.makeText(context.getApplicationContext(), "GANAS", Toast.LENGTH_LONG).show();
					fin=1;
				}
				if (verificaGana() == 2) {
					Toast.makeText(context.getApplicationContext(), "PIERDES", Toast.LENGTH_LONG).show();
					fin=1;
				}
				if (verificaGana() == 0) {
					Toast.makeText(context.getApplicationContext(), "EMPATE", Toast.LENGTH_LONG).show();
					fin=1;
				}
			}
		}
